...
lib.ssMetadata = [
		{name:"TreasureIsland_atlas_1", frames: [[0,362,276,228],[0,0,372,360],[374,0,372,360],[278,362,322,181],[748,339,253,266],[1491,552,285,127],[1270,441,219,236],[1003,500,219,236],[278,545,219,236],[1224,681,299,104],[748,0,281,337],[1584,0,253,310],[1839,0,188,268],[1839,270,207,243],[1031,0,551,167],[1491,495,52,50],[1994,515,52,50],[1886,515,106,122],[1834,515,50,590],[1031,169,237,329],[1778,552,51,50],[1994,567,51,50],[672,524,64,69],[499,607,285,127],[1546,312,286,238],[1491,441,52,52],[602,362,141,160],[0,592,165,167],[786,607,165,167],[1270,169,274,270],[1224,545,43,42],[1224,500,43,43],[602,524,68,68],[499,545,58,58],[167,592,97,104]]},
		{name:"TreasureIsland_atlas_2", frames: [[1294,481,451,452],[1258,935,418,452],[0,0,1177,417],[0,1193,1178,382],[0,1577,1292,327],[0,419,1241,389],[1678,935,356,479],[1294,1416,400,400],[1294,0,592,479],[0,1906,2021,84],[0,810,1256,381]]},
		{name:"TreasureIsland_atlas_3", frames: [[961,0,946,716],[0,737,1438,480],[0,1219,1174,542],[0,0,959,735]]},
		{name:"TreasureIsland_atlas_4", frames: [[0,1066,1422,617],[0,0,1386,1064]]},
		{name:"TreasureIsland_atlas_5", frames: [[0,0,1172,707],[0,709,1173,699]]},
		{name:"TreasureIsland_atlas_6", frames: [[0,1250,1354,561],[0,694,1455,554],[0,0,1173,692]]},
		{name:"TreasureIsland_atlas_7", frames: [[0,0,1499,1174]]},
		{name:"TreasureIsland_atlas_8", frames: [[0,940,1176,471],[0,1413,1176,445],[0,0,1193,523],[0,525,1456,413]]},
		{name:"TreasureIsland_atlas_9", frames: [[0,0,1920,1080]]},
...
p.nominalBounds = new cjs.Rectangle(110,88,268.1,216.89999999999998);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.sound_btnjpg();
	this.instance.setTransform(48,0);

	this.instance_1 = new lib.sound_btnover();
	this.instance_1.setTransform(48,0);

	this.instance_2 = new lib.SoundOff_btn();
	this.instance_2.setTransform(43,-8);
...
p.nominalBounds = new cjs.Rectangle(43,-8,64,69);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.pause_btnjpg();
	this.instance.setTransform(48,0);

	this.instance_1 = new lib.pause_btnover();
	this.instance_1.setTransform(48,0);
...
p.nominalBounds = new cjs.Rectangle(48,0,52,50);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(2.65,2,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_4();
	this.instance_2.setTransform(1.25,2.5,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_5();
	this.instance_3.setTransform(0,70,0.5,0.5);

	this.instance_4 = new lib.CachedBmp_6();
	this.instance_4.setTransform(-2.85,137.7,0.5,0.5);

	this.instance_5 = new lib.CachedBmp_7();
	this.instance_5.setTransform(-2.75,164.85,0.5,0.5);

	this.instance_6 = new lib.CachedBmp_8();
	this.instance_6.setTransform(-3,163.3,0.5,0.5);

	this.instance_7 = new lib.CachedBmp_9();
	this.instance_7.setTransform(-3.6,162.7,0.5,0.5);

	this.instance_8 = new lib.CachedBmp_10();
	this.instance_8.setTransform(-1.05,161.05,0.5,0.5);

	this.instance_9 = new lib.CachedBmp_11();
	this.instance_9.setTransform(-1.65,159.05,0.5,0.5);

	this.instance_10 = new lib.CachedBmp_12();
	this.instance_10.setTransform(-2.2,158.1,0.5,0.5);

	this.instance_11 = new lib.CachedBmp_13();
	this.instance_11.setTransform(-2.9,160.45,0.5,0.5);

	this.instance_12 = new lib.CachedBmp_14();
	this.instance_12.setTransform(-3.2,159.25,0.5,0.5);

	this.instance_13 = new lib.CachedBmp_15();
	this.instance_13.setTransform(-2.75,125.05,0.5,0.5);

	this.instance_14 = new lib.CachedBmp_16();
	this.instance_14.setTransform(-2.4,111.6,0.5,0.5);

	this.instance_15 = new lib.CachedBmp_17();
	this.instance_15.setTransform(-2.85,105.65,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-3.6,0,730.1,467.6);
...
if (reversed == null) { reversed = false; }
	...
	this.text.parent = this;
	this.text.setTransform(56.55,631.25,0.6072,0.6072);

	this.instance = new lib.treasureBox_goldjpg();
	this.instance.setTransform(24,622,0.5163,0.5174);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.text}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.MadHazahavIcon, new cjs.Rectangle(24,622,85.2,86.39999999999998), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF9933").s().p("ApiDhQhkAAAAhkIAAj5QAAhkBkAAITFAAQBkAAAABkIAAD5QAABkhkAAg");
...
p.nominalBounds = new cjs.Rectangle(-76,-27,150.4,52.3);
...
if (reversed == null) { reversed = false; }
	...
	this.mycb = new lib.an_ComboBox({'id': 'mycb', 'label':'', 'items':'dummy, dummy, items, 2, label, 0, , , data, 0, , , 3, בחר נושא, 0, מנהיגים בישראל, 1, טבע ישראלי, 2', 'value':'0', 'disabled':false, 'visible':true, 'class':'ui-combobox'});

	this.mycb.name = "mycb";
	this.mycb.setTransform(367.6,118.05,1.52,1.3636,0,0,0,50.1,11.1);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.startbtn},{t:this.mycb},{t:this.ComboBox}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.forcombo, new cjs.Rectangle(42,102.2,407.5,265.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.graphics.f().s("#666666").ss(0.1,1,1).p("AyVseMAkqAAAQCWAAAACWIAAURQAACWiWAAMgkqAAAQiWAAAAiWIAA0RQAAiWCWAAg");
	this.shape_2.setTransform(181.2763,-50.7686,0.6013,0.6711);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AyVMfQiVAAAAiWIAA0RQAAiWCVAAMAkqAAAQCWAAABCWIAAURQgBCWiWAAg");
	this.shape_3.setTransform(181.2763,-50.7686,0.6013,0.6711);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2}]}).to({state:[{t:this.shape_5},{t:this.shape_4}]},1).to({state:[{t:this.shape_7},{t:this.shape_6}]},1).to({state:[{t:this.shape_9},{t:this.shape_8}]},1).to({state:[{t:this.shape_11},{t:this.shape_10}]},1).to({state:[{t:this.shape_3},{t:this.shape_2}]},1).to({state:[]},1).wait(14));

	// Layer_1
	this.instance_5 = new lib.treasureBox_closejpg();
	this.instance_5.setTransform(-4,-45,0.8172,0.8247);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#999999").ss(1,1,1).p("AAAApIAAhR");
	this.shape_12.setTransform(66.85,-4.05);

	this.instance_6 = new lib.treasureBox_sculp();
	this.instance_6.setTransform(-45,-80,0.5495,0.5262);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#999999").ss(1,1,1).p("AAAAoIAAhP");
	this.shape_13.setTransform(53.45,-9.725);

	this.instance_7 = new lib.treasureBox_goldjpg();
	this.instance_7.setTransform(-40,-80,0.8769,0.8372);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.instance_5,p:{scaleX:0.8172}}]}).to({state:[{t:this.instance_5,p:{scaleX:0.8164}}]},1).to({state:[{t:this.shape_13,p:{x:53.45,y:-9.725}},{t:this.instance_6}]},1).to({state:[{t:this.shape_13,p:{x:53.1,y:-9.625}},{t:this.instance_7}]},1).to({state:[{t:this.instance_5,p:{scaleX:0.8172}}]},1).to({state:[{t:this.instance_5,p:{scaleX:0.8172}}]},1).to({state:[]},1).wait(14));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-45,-130.3,314.1,217.3);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		function combo_bk() {
			...
			console.log($("#dom_overlay_container").on("change", "#mycb", mycb_change));
		}
		...
		function startAnimation() {
			...
			var timer_story = setTimeout(story, 12500);
		}
		...
		function Progress() {
			...
			//לפי אורך המערך
			progressBarSteps = 1 / Question.length;
		...
		function theGame() {
			...
			{
				Qtitle.text = Question[RandQ][0][0]; //הצג טקסט
				stage.addChild(Qtitle);
			...
			//console.log("מספר ההופעות של השאלה " + Question[0][RandQ][0][2])
			...
			[
				...
				[
					[600, 605], //שורה ראשונה שמאלי
					[300, 605] //שורה ראשונה אמצעי
				]
			]
			...
			for (var i = 1; i <= Question[RandQ].length - 1; i++) {
				...
				if (Question[RandQ][i][0] == "") //אם המסיח הוא תמונה
				{
		...
		function click_glassbtn(evt) {
			...
			if (glassOn == "true") {
				if (picBig == 0) {
					picIsBig = r;
					stage.getChildByName("object" + r).getChildByName("Answer" + r).scaleX = 1.3;
					stage.getChildByName("object" + r).getChildByName("Answer" + r).scaleY = 1.3;
					stage.getChildByName("object" + r).getChildByName("Answer" + r).x -= 65;
					stage.getChildByName("object" + r).getChildByName("Answer" + r).y += 5;
			...
			if (glassOnQ == "true") {
				...
				if (picBig == 1) {
					...
					stage.getChildByName("pic").scaleX = 1.5;
					stage.getChildByName("pic").scaleY = 1.5;
					picBig = 1;
				}
			}
		...
		function CheckAns() {
			...
			} else //תשובה שגויה
			{
				...
				//משוב אי הצלחה תיבה משתנה לאדום
				...
				var timer_continueB = setTimeout(continueButton, 3500);
		...
		function RightAnswer() { //תפעיל פונקציה לתשובה נכונה
			...
			//אנימציה מטבעות
			var timer_coins = setTimeout(coinsFunc, 500);
		
			totalScore += 100 / (10 * Question[RandQ][0][2]); //הוספת הציון של השאלה לציון הסופי
			console.log("questionScore- " + 100 / (10 * Question[RandQ][0][2]))
			...
			countQ++;
			proOutOf.text = "שאלות במשחק " + "10" + " / " + countQ;
		
			//הוספת צלילים
		
		
			// מד הזהב מתמלא בהתאם
			var timer_scale = setTimeout(fillBar, 3000);
			...
			var timer_nextq = setTimeout(nextqFunc, 5000);
		
		}
		
		function nextqFunc() {
			if (successtotal == 10) //אם כל התשובות נענו-מסך סיום
			{
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/CachedBmp_24.png?1643576485549", id:"CachedBmp_24"},
		{src:"images/CachedBmp_23.png?1643576485549", id:"CachedBmp_23"},
		{src:"images/CachedBmp_22.png?1643576485549", id:"CachedBmp_22"},
		{src:"images/background_questionsjpg.png?1643576485549", id:"background_questionsjpg"},
		{src:"images/final_score_background.png?1643576485549", id:"final_score_background"},
		{src:"images/Golda_Meir.jpg?1643576485549", id:"Golda_Meir"},
		{src:"images/timeover_popUp.png?1643576485549", id:"timeover_popUp"},
		{src:"images/TreasureIsland_atlas_1.png?1643576485376", id:"TreasureIsland_atlas_1"},
		{src:"images/TreasureIsland_atlas_2.png?1643576485376", id:"TreasureIsland_atlas_2"},
		{src:"images/TreasureIsland_atlas_3.png?1643576485376", id:"TreasureIsland_atlas_3"},
		{src:"images/TreasureIsland_atlas_4.png?1643576485376", id:"TreasureIsland_atlas_4"},
		{src:"images/TreasureIsland_atlas_5.png?1643576485376", id:"TreasureIsland_atlas_5"},
		{src:"images/TreasureIsland_atlas_6.png?1643576485376", id:"TreasureIsland_atlas_6"},
		{src:"images/TreasureIsland_atlas_7.png?1643576485376", id:"TreasureIsland_atlas_7"},
		{src:"images/TreasureIsland_atlas_8.png?1643576485376", id:"TreasureIsland_atlas_8"},
		{src:"images/TreasureIsland_atlas_9.png?1643576485376", id:"TreasureIsland_atlas_9"},
		{src:"images/TreasureIsland_atlas_10.png?1643576485376", id:"TreasureIsland_atlas_10"},
		{src:"sounds/blopCharacter.mp3?1643576485549", id:"blopCharacter"},
		{src:"sounds/coinsFillBar.mp3?1643576485549", id:"coinsFillBar"},
		{src:"sounds/EndAnimation.mp3?1643576485549", id:"EndAnimation"},
		{src:"sounds/GameSound.mp3?1643576485549", id:"GameSound"},
		{src:"sounds/openChest.mp3?1643576485549", id:"openChest"},
		{src:"sounds/pirate.mp3?1643576485549", id:"pirate"},
		{src:"sounds/shakingBones.mp3?1643576485549", id:"shakingBones"},
		{src:"sounds/ShakingBox.mp3?1643576485549", id:"ShakingBox"},
		{src:"sounds/sleep.mp3?1643576485549", id:"sleep"},
		{src:"sounds/sound_win_coin.mp3?1643576485549", id:"sound_win_coin"},
		{src:"sounds/startAnimationSound.mp3?1643576485549", id:"startAnimationSound"},
		{src:"sounds/taDa.mp3?1643576485549", id:"taDa"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1643576485549", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1643576485549", id:"sdk/anwidget.js"},
		{src:"components/ui/src/css.js?1643576485549", id:"an.CSS"},
		{src:"components/ui/src/combobox.js?1643576485549", id:"an.ComboBox"}
	],
	preloads: []
};
